...
console.log(`🔗 GitHub Actions: https://github.com/skkut/SilkStack-Image-Browser/actions`);
console.log(`📋 Release will be created automatically at:`);
console.log(`   https://github.com/skkut/SilkStack-Image-Browser/releases/tag/v${VERSION}`);
console.log('='.repeat(60));
console.log('\n📝 What happens next:');
